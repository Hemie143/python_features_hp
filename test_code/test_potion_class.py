...
def flask_of_remembrance():
    return Potion(['raven eggshells', 'tincture of thyme', 'unicorn tears', 'dried onions',
...
def test_iterator_behavior(flask_of_remembrance):
    ...
    assert all_ingredients == ['raven eggshells', 'tincture of thyme', 'unicorn tears', 'dried onions',
                                   'powdered ginger root']
