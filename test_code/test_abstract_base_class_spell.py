import pytest
from python_features_hp.magic_universe import Spell, Charm, Transfiguration, Hex, Curse, Jinx, HealingSpell, \
    CounterSpell
...
def alteraror_canieo():
    return Transfiguration.alterator_canieo()
...
def test_jinx_defining_feature(inceptotis):
    assert inceptotis.defining_feature == "Minor dark magic - " \
...
def test_counter_spell_defining_feature(mufindo_immolim):
    assert mufindo_immolim.defining_feature == "Inhibits the effects of another spell"
